...
/*
INSERT INTO course (course_id, course_code, course_name, course_units, course_description, course_prerequisites, course_type, course_group,
course_instructor) VALUES
(1, "CS110", "Theory of Computation", 3, "Studies the theory of computation", "CS109", "Lecture", "Professional", "Henry Yrneh"),
(2, "RW2", "Works of Rizal", 3, "Studies the Works of Rizal", "RW1", "Lecture", "General", "Henry Yrneh"),
(3, "CS109", "Algorithms and Complexity", 3, "Studies algorithms and complexity", "CS108", "Lecture", "Professional", "Henry Yrneh"),
(4, "FIL23", "Filipino Literature", 3, "Studies Philippine Literature", "CS109", "Lecture", "General", "Josie Eisoj"),
(5, "PHYS110", "Statistical Mechanics", 3, "Studies statistical mechanics", "PHYS109", "Laboratory", "Professional", "Albert Trebla"),
(6, "PHYS112", "Quantum Mechanics", 3, "Studies quantum mechanics", "PHYS111", "Lecture", "Professional", "Albert Trebla"),
(7, "PHYS110", "Statistical Mechanics", 3, "Studies statistical mechanics", "PHYS109", "Laboratory", "Professional", "Madeline Eniledam"),
(8, "PE4", "Physical Education 4", 3, "Studies Physical Education", "PE3", "Laboratory", "General", "Albus Subla");
...
(5, "DOST Scholarshipp", "Needs-based");
...
"Bachelor of Science in Computer Science", "Elsa H. Rodrigo", "Narciso A. Bullok", 1000000, 3, 2, 92),
...
"Bachelor of Science in Computer Science", "Tran A. Hieu", "Hugh C. Jackman", 250000, 4, 2, 80),
(6, "Zack", "Tabuldo", "Apron", "Male", '2001-12-10', 6, 95, "Bachelor of Science in Computer Science", 
"Bachelor of Arts in Filipino", "Matutina P. Tabudlo", "Keech N. Apron", 150000, 5, 2, 90),
...
INSERT INTO course_curriculum(curriculum_id, course_id) VALUES (10, 8);
-- INSERT INTO course_curriculum(curriculum_id, course_id) VALUES (1, 3);
